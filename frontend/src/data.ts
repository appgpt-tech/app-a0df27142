...
let data: any = {
  defaultData: {
    ...
    DifficultyLevels: [
      { difficultyId: 1, name: 'name 1', description: 'description 1', id: 82 },
      { difficultyId: 2, name: 'name 2', description: 'description 2', id: 30 },
      { difficultyId: 3, name: 'name 3', description: 'description 3', id: 53 },
      { difficultyId: 4, name: 'name 4', description: 'description 4', id: 15 },
      { difficultyId: 5, name: 'name 5', description: 'description 5', id: 93 },
    ],
  },
};
export default data;
